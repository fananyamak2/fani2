...
import 'package:fani/pages/home.dart';
...
class _DateAndTimeState extends State<DateAndTime> {
  ...
  final List<String> _repeat = ['شهريا', 'اسبوعيا', 'يوميا', 'مرة واحدة'];
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  child: Column(
                    children: [
                      // Container(child: Text('اختيار تاريخ:' '$_date')),
                      Card(
...
class PickerSelectedDate extends StatefulWidget {
  const PickerSelectedDate({super.key});
  @override
    ...
    return MaterialApp(
      home: Scaffold(
        body: SafeArea(
          child: Column(
            children: [
              Container(height: 50, child: Text('اختيار تاريخ:' '$_date')),
              Card(
